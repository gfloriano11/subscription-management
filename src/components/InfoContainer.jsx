function InfoContainer({icon, text, border, shadow, background}){
    return(
        <div className="hover:scale-102 transform duration-300 w-3/5 min-w-50 max-w-85 h-40 gap-3 flex flex-col justify-around items-center bg-gray-50 p-4 rounded-md">
